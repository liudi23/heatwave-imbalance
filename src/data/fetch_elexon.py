# NOTE: vendored verbatim from the sister repo `uk-system-price-forecast` for
# standalone reproducibility. Keep in sync with that repo (identical SP/UK-time
# convention and retry/append/CLI contract). See docs/DATA_SOURCES.md.
